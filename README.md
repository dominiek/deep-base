...
Today's deep learning frameworks require an extraordinary amount of to install and run. This Docker container bundles all popular deep learning frameworks into a single Docker image. Ubuntu Linux is the OS of choice for base of this image (it is a requirement for CUDA and all DL frameworks play nice with it).
